...
public class Bug_46848 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void Bug_46848() throws InterruptedException, IOException, BiffException, WriteException {
...
//Available Bucket------------------------
        ...
        Thread.sleep(700);
        int expectedVarianceV1_Page = 1;
        int variance_1_CountVariance = Integer.parseInt(Reuseable_Library.captureText(driver,"//span[contains(text(),'UPGRADE-TRADEIN ')]/span[1]","UPGRADE-TRADEIN bucket variance count",logger));
        //Assert.assertEquals(variance_1_CountVariance,expectedVarianceV1_Page);

        if (variance_1_CountVariance == expectedVarianceV1_Page) {
            logger.log(LogStatus.PASS, "Variance count on Variance 1 page is : " + variance_1_CountVariance + " and the Test Result is ======== PASS ======== ");
        }else {
            logger.log(LogStatus.FAIL, "Variance count on Variance 1 page is : " + variance_1_CountVariance + " and the Test Result is ======== FAIL ======== ");
            Reuseable_Library.getScreenShot(driver,logger,"Variance 1 Page");
        }
        ...
        Thread.sleep(700);
        int expectedVarianceV2_Page =0;
        int variance_2_CountVariance= Integer.parseInt(Reuseable_Library.captureText(driver,"//span[contains(text(),'UPGRADE-TRADEIN ')]/span[1]","UPGRADE-TRADEIN bucket variance count",logger));
        //Assert.assertEquals(variance_2_CountVariance,expectedVarianceV2_Page);
        if (variance_2_CountVariance == expectedVarianceV2_Page) {
            logger.log(LogStatus.PASS, "Variance count on Variance 2 page is : " + variance_2_CountVariance + " and the Test Result is ======== PASS ======== ");
        }else {
            logger.log(LogStatus.FAIL, "Variance count on Variance 2 page is : " + variance_2_CountVariance + " and the Test Result is ======== FAIL ======== ");
            Reuseable_Library.getScreenShot(driver,logger,"Variance 2 page");
        }
