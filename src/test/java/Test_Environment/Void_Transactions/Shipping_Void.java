...
public class Shipping_Void extends Abstract_Class {
    ...
    @Test
    public void Shipping_Void() throws InterruptedException, IOException {
 ...
 */
        ...
        Thread.sleep(1500);
        Base_Class.shippingAdding_page().void_Button();

        Thread.sleep(1000);
        Base_Class.shippingAdding_page().continue_void();


        //Logout from XInventory
        Thread.sleep(2000);
