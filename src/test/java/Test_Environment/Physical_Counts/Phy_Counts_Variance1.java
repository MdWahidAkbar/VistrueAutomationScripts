...
public class Phy_Counts_Variance1 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    public void Phy_Counts_Variance1() throws InterruptedException, IOException, BiffException, WriteException {
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Thread.sleep(500);
            Base_Class.initialCount_page().ReturnSKUIMEIsearch_Field(RDIMEIV1);
            Thread.sleep(700);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Base_Class.initialCount_page().ReturnSKUIMEIsearch_Field(RDSKUV1);
            Thread.sleep(700);
            System.out.println("The SKU is :"+RDSKUV1);
            Base_Class.initialCount_page().returnSKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String RDNOSV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(19));
            Base_Class.initialCount_page().returnNonSerializedSKU_Input(RDNOSV1);
            Thread.sleep(1000);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Thread.sleep(500);
            Base_Class.initialCount_page().UpgradeSKUIMEIsearch_Field(UPTIMEIV1);
            Thread.sleep(700);
