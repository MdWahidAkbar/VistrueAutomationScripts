...
public class Phy_Counts_NoVariance extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void Phy_Counts_NoVariance() throws InterruptedException, IOException, BiffException, WriteException {
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Base_Class.initialCount_page().ReturnSKUIMEIsearch_Field(RDIMEI);
            Thread.sleep(700);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Thread.sleep(800);
            Base_Class.initialCount_page().ReturnSKUIMEIsearch_Field(RDSKU);
            Thread.sleep(800);
            System.out.println("The SKU is :"+RDSKU);
            Base_Class.initialCount_page().returnSKUIMEIsearchFiled_AddButton();
            Thread.sleep(1000);
            String RDNOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(8));
            Base_Class.initialCount_page().returnNonSerializedSKU_Input(RDNOS);
            Thread.sleep(1500);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Thread.sleep(500);
            Base_Class.initialCount_page().UpgradeSKUIMEIsearch_Field(UPTIMEI);
            Thread.sleep(700);
