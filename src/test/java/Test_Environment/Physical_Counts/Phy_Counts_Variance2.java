package Test_Environment.Physical_Counts;
...
public class Phy_Counts_Variance2 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void Phy_Counts_Variance1() throws InterruptedException, IOException, BiffException, WriteException {
        ...
        for (int i=1; i<=rowcount; i++) {
            String IMEIV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(25));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKUV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(26));
            ...
            Base_Class.initialCount_page().SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String NOSV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(27));
        ...
        for (int i=1; i<=rowcount; i++) {
            String RDIMEIV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(28));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String RDSKUV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(29));
            ...
            Base_Class.initialCount_page().returnSKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String RDNOSV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(30));
        ...
        for (int i=1; i<=rowcount; i++) {
            String UPTIMEIV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(31));
        ...
        //RESERVED Bucket--------------------------------------------------------------------------------
        Thread.sleep(800);
        Base_Class.initialCount_page().reserved_Button();

        for (int i=1; i<=rowcount; i++) {
            String RSRVIMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(32));

            //To skip the Null or Empty Cell
            if(RSRVIMEI == null || RSRVIMEI.equalsIgnoreCase("") || RSRVIMEI.isEmpty()){
                break;
            }
            Thread.sleep(500);
            Base_Class.initialCount_page().reserved_Physical_SKUIMEIsearch_Field(RSRVIMEI);
            Thread.sleep(700);
            System.out.println("The IMEI is :"+RSRVIMEI);
            Base_Class.initialCount_page().reserved_Physical_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            logger.log(LogStatus.PASS,"Entered IMEI is :"+RSRVIMEI);

        }//END OF FOR LOOP FOR IMEI

        for (int i=1; i<=rowcount; i++) {

            String RSRVSKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(33));

            //To skip the Null or Empty Cell
            if(RSRVSKU == null || RSRVSKU.equalsIgnoreCase("") || RSRVSKU.isEmpty()){
                break;
            }
            Thread.sleep(800);
            Base_Class.initialCount_page().reserved_Physical_SKUIMEIsearch_Field(RSRVSKU);
            Thread.sleep(800);
            System.out.println("The SKU is :"+RSRVSKU);
            Base_Class.initialCount_page().reserved_Physical_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(1000);
            String RSRVNOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(34));
            Base_Class.initialCount_page().reserved_Physical_NonSerializedSKU_Input(RSRVNOS);
            Thread.sleep(1500);
            logger.log(LogStatus.PASS,"Entered SKU is :"+RSRVSKU+" and Items got scanned are :"+RSRVNOS);
...
//Available Bucket------------------------
        for (int i=1; i<=rowcount; i++) {
            String IMEIV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(14));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKUV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(15));
            ...
            String NOSV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(16));
        ...
        for (int i=1; i<=rowcount; i++) {
            String RDIMEIV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(17));
        ...
        for (int i=1; i<=rowcount; i++) {
            String RDSKUV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(18));
            //To skip the Null or Empty Cell
            ...
            Base_Class.varianceCount_page().returnSKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String RDNOSV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(19));
        ...
        for (int i=1; i<=rowcount; i++) {
            String UPTIMEIV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(20));
        ...
        //RESERVED Bucket--------------------------------------------------------------------------------
        Thread.sleep(800);
        Base_Class.varianceCount_page().reserved_Button();

        for (int i=1; i<=rowcount; i++) {
            String RSRVIMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(21));
            ...
            Thread.sleep(500);
            Base_Class.varianceCount_page().reserved_Physical_SKUIMEIsearch_Field(RSRVIMEI);
            Thread.sleep(700);
            System.out.println("The IMEI is :"+RSRVIMEI);
            Base_Class.varianceCount_page().reserved_Physical_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            logger.log(LogStatus.PASS,"Entered IMEI is :"+RSRVIMEI);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String RSRVSKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(22));
            ...
            Thread.sleep(800);
            Base_Class.varianceCount_page().reserved_Physical_SKUIMEIsearch_Field(RSRVSKU);
            Thread.sleep(800);
            System.out.println("The SKU is :"+RSRVSKU);
            Base_Class.varianceCount_page().reserved_Physical_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(1000);
            String RSRVNOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(23));
            Base_Class.varianceCount_page().reserved_Physical_NonSerializedSKU_Input(RSRVNOS);
            Thread.sleep(1500);
            logger.log(LogStatus.PASS,"Entered SKU is :"+RSRVSKU+" and Items got scanned are :"+RSRVNOS);
        ...
        for (int i=1; i<=rowcount; i++) {
            String RSRVIMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(10));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String RSRVSKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(11));
            ...
            Base_Class.varianceCount_page().reserved_Physical_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(1000);
            String RSRVNOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(12));
            Base_Class.varianceCount_page().reserved_Physical_NonSerializedSKU_Input(RSRVNOS);
            Thread.sleep(1500);
            logger.log(LogStatus.PASS,"Entered SKU is :"+RSRVSKU+" and Items got scanned are :"+RSRVNOS);
