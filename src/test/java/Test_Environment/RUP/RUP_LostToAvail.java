...
public class RUP_LostToAvail extends Abstract_Class {
    ...
    @Test
    public void RUP_LostToAvail() throws InterruptedException, IOException {
        ...
        Thread.sleep(2000);
        Base_Class.adjustInventory_page().available_To_Bucket();
        Thread.sleep(1000);
        ...
        for (int i = 1; i<=rowcount; i++) {
            ...
            Base_Class.adjustInventory_page().lost_from_Bucket();
            Thread.sleep(1000);
            Base_Class.adjustInventory_page().available_To_Bucket();
            Thread.sleep(1000);
