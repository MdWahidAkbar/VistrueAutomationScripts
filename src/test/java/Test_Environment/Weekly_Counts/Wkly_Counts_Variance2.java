package Test_Environment.Weekly_Counts;
...
public class Wkly_Counts_Variance2 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void WeeklyCounts_Variance2() throws InterruptedException, IOException, BiffException, WriteException {
        ...
        fis = new FileInputStream("C:\\Users\\wahid.akbar\\OneDrive - Transcendent Solutions\\Documents\\TestDataProd\\ProdWeeklyCount.xlsx");
        ...
        for (int i=1; i<=rowcount; i++) {
            String IMEIV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(17));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKUV2 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(18));
            ...
            Base_Class.initialCount_page().SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String NOSV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(19));
        ...
        //For RESERVED bucket=================================================
        for (int i=1; i<=rowcount; i++) {
            String IMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(20));
            ...
            Thread.sleep(500);
            Base_Class.initialCount_page().reserved_Weekly_SKUIMEIsearch_Field(IMEI);
            Thread.sleep(700);
            System.out.println("The IMEI is :"+IMEI);
            Base_Class.initialCount_page().reserved_Weekly_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(21));
            //To skip the Null or Empty Cell
            if(SKU == null || SKU.equalsIgnoreCase("") || SKU.isEmpty()){
                break;
            }
            Thread.sleep(500);
            Base_Class.initialCount_page().reserved_Weekly_SKUIMEIsearch_Field(SKU);
            Thread.sleep(700);
            System.out.println("The SKU is :"+SKU);
            Base_Class.initialCount_page().reserved_Weekly_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);

            String NOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(22));
            Base_Class.initialCount_page().reserved_Weekly_NonSerializedSKU_Input(NOS);
            Thread.sleep(1000);
        ...
        for (int i=1; i<=rowcount; i++) {
            String IMEIV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(10));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKUV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(11));
            ...
            Base_Class.varianceCount_page().SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            String NOSV1 = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(12));
        ...
        //For RESERVED bucket=================================================
        for (int i=1; i<=rowcount; i++) {
            String IMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(13));
            ...
            Thread.sleep(500);
            Base_Class.varianceCount_page().reserved_Weekly_SKUIMEIsearch_Field(IMEI);
            Thread.sleep(700);
            System.out.println("The IMEI is :"+IMEI);
            Base_Class.varianceCount_page().reserved_Weekly_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);
            logger.log(LogStatus.PASS,"Entered IMEI is :"+IMEI);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(14));
            //To skip the Null or Empty Cell
            if(SKU == null || SKU.equalsIgnoreCase("") || SKU.isEmpty()){
                break;
            }
            Thread.sleep(500);
            Base_Class.varianceCount_page().reserved_Weekly_SKUIMEIsearch_Field(SKU);
            Thread.sleep(700);
            System.out.println("The SKU is :"+SKU);
            Base_Class.varianceCount_page().reserved_Weekly_SKUIMEIsearchFiled_AddButton();
            Thread.sleep(700);

            String NOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(15));
            Base_Class.varianceCount_page().reserved_Weekly_NonSerializedSKU_Input(NOS);
            Thread.sleep(1000);
            logger.log(LogStatus.PASS,"Entered SKU is :"+SKU+" and Items got scanned are :"+NOS);
        ...
        //For RESERVED bucket=================================================
        for (int i=1; i<=rowcount; i++) {
            String IMEI = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(6));
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            String SKU = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(7));
            //To skip the Null or Empty Cell
            if(SKU == null || SKU.equalsIgnoreCase("") || SKU.isEmpty()){
                break;
            }
            ...
            String NOS = dataFormatter.formatCellValue(sheet1.getRow(i).getCell(8));
            Base_Class.varianceCount_page().reserved_Weekly_NonSerializedSKU_Input(NOS);
            Thread.sleep(1000);
            logger.log(LogStatus.PASS,"Entered SKU is :"+SKU+" and Items got scanned are :"+NOS);
