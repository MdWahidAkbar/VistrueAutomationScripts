...
public class Wkly_Counts_Variance1 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void WeeklyCounts_Variance1() throws InterruptedException, IOException, BiffException, WriteException {
