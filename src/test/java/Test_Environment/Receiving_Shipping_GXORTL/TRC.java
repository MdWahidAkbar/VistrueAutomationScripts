package Test_Environment.Receiving_Shipping_GXORTL;
...
public class TRC extends Abstract_Class {
...
/*
        String tranNumTSU = dataFormatter.formatCellValue(sheet1.getRow(13).getCell(1));
        Base_Class.pharos_transaction_popUp().trannum(tranNumTSU);
        Thread.sleep(500);

        //If we use the above then only save and release will complete the TRC
 */
        ...
        Base_Class.pharos_receivingPopUp().serialiList();
        Thread.sleep(1000);
        ...
        //Need to Put the location again=============================================================================
        Base_Class.pharos_transaction_popUp().toLocation(toLocation);
        Thread.sleep(1000);
