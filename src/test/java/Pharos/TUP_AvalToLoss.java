...
public class TUP_AvalToLoss extends Abstract_Class {
    ...
    @Test
    public void TUP_Serialized_AailToLoss() throws InterruptedException, IOException {
        ...
        Base_Class.pharos_currentTransaction_page().pharos_TUP();
        ...
        String toStatus = sheet1.getRow(14).getCell(1).getStringCellValue();
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            logger.log(LogStatus.INFO," The serial number got input is : "+IMEI);
            Thread.sleep(500);
        ...
        sheet1.getRow(23).createCell(1).setCellValue(trannum);
        ...
        String tranNum_Input = sheet1.getRow(23).getCell(1).getStringCellValue();
