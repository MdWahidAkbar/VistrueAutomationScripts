...
public class B_TRC_IQ extends Abstract_Class {
    ...
    @Test
    public void TRC_NonSerialized() throws InterruptedException, IOException {
        ...
        String tranNum = dataFormatter.formatCellValue(sheet1.getRow(15).getCell(1));
        Base_Class.pharos_transaction_popUp().trannum(tranNum);
        Thread.sleep(500);
        ...
        sheet1.getRow(20).createCell(1).setCellValue(trannum);
        Thread.sleep(1000);
        ...
        String tranNum_Input = sheet1.getRow(20).getCell(1).getStringCellValue();
