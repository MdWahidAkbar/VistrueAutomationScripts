...
public class TUP_IQ extends Abstract_Class {
    ...
    @Test
    public void TUP_NonSerialized() throws InterruptedException, IOException {
        ...
        driver.findElement(By.xpath("//*[@id='tableContainer']")).click();
        Thread.sleep(1000);
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            logger.log(LogStatus.INFO,"The SKU is : "+SKU);
            Thread.sleep(700);
        ...
        sheet1.getRow(24).createCell(1).setCellValue(trannum);
        Thread.sleep(1000);
        ...
        String tranNum_Input = sheet1.getRow(24).getCell(1).getStringCellValue();
