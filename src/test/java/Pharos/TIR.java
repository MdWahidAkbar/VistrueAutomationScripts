...
public class TIR extends Abstract_Class {
    ...
    @Test
    public void TIR_Serialized() throws InterruptedException, IOException {
        ...
        Base_Class.pharos_currentTransaction_page().pharos_TIR();
        ...
        String fromSite = sheet1.getRow(13).getCell(1).getStringCellValue();
        Base_Class.pharos_transaction_popUp().toSite(fromSite);
        Thread.sleep(500);

        String toStatus = sheet1.getRow(8).getCell(1).getStringCellValue();
        Base_Class.pharos_receivingPopUp().toStatus(toStatus);
        Thread.sleep(500);
...
/*
        String tranNum = dataFormatter.formatCellValue(sheet1.getRow(1).getCell(10));
        driver.findElement(By.xpath("//*[@id='txtTransactionLookupTrannum']")).sendKeys(tranNum);
 */
        ...
        for (int i=1; i<=rowcount; i++) {
            ...
            Thread.sleep(500);
            //Base_Class.pharos_serialized_popUp().serial_Input(IMEI);
        ...
        sheet1.getRow(22).createCell(1).setCellValue(trannum);
        ...
        String tranNum_Input = sheet1.getRow(22).getCell(1).getStringCellValue();
