...
public class TUP_LossToAvail extends Abstract_Class {
    ...
    public void TUP_Serialized_AailToLoss() throws InterruptedException, IOException {
        ...
        sheet1.getRow(25).createCell(1).setCellValue(trannum);
        ...
        String tranNum_Input = sheet1.getRow(25).getCell(1).getStringCellValue();
