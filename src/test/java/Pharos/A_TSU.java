...
public class A_TSU extends Abstract_Class {
    ...
    @Test
    public void TSU_Serialized() throws InterruptedException, IOException {
        ...
        Thread.sleep(500);
        //For TSU I used AAS1 (Spoke) as Site visibility to ship to AAR11
        ...
        String soSite = sheet1.getRow(3).getCell(1).getStringCellValue();
        ...
        sheet1.getRow(15).createCell(1).setCellValue(trannum);
        ...
        String tranNum_Input = sheet1.getRow(15).getCell(1).getStringCellValue();
