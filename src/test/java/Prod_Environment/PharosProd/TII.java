...
public class TII extends Abstract_Class {
    ...
    @Test
    public void TII_Serialized() throws InterruptedException, IOException {
        ...
        Base_Class.pharos_currentTransaction_page().pharon_TII();
        Thread.sleep(1000);
        ...
        String toSite = sheet1.getRow(13).getCell(1).getStringCellValue();
        ...
        sheet1.getRow(21).createCell(1).setCellValue(trannum);
        ...
        String tranNum_Input = sheet1.getRow(21).getCell(1).getStringCellValue();
