...
public class Counts_Variance1 extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void Counts_AllBuckets_Variance1Page() throws InterruptedException, IOException, BiffException, WriteException {
