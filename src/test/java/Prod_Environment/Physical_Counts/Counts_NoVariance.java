...
public class Counts_NoVariance extends Abstract_Class {
   ...
   //for XLSX spread sheet data driven
    ...
    @Test()
    public void CountsNoVariance_AllBucket() throws InterruptedException, IOException, BiffException, WriteException {
